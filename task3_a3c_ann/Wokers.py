...
if __name__ == '__main__':
    ...
    load_path = 'saved_models/a3c_ann_h2w2_intelGhost_lr1e-4_gamma0.9_1mIteration_0411.pt'
    save_path = 'saved_models/a3c_ann_h2w2_intelGhost_lr1e-4_gamma0.9_1mIteration_0411.pt'
    lr = 1e-4*5
    n_actions = 4
    input_dims = [15]
